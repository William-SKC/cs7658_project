...
A1 = RobotWrapper.BuildFromURDF(A1modelPath + URDF_FILENAME, [A1modelPath], pinocchio.JointModelFreeFlyer()) #generate the robot model

# Add free flyer joint limits (upper bounds and lowe bounds for joints)
rmodel = A1.model
...
walking_gait = {'stepLength': 0.25, 'stepHeight': 0.2, 'timeStep': 5e-3, 'stepKnots': 40, 'supportKnots': 2} # trajectory goal
